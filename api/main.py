...
# ── Streaming subsystem (independent event-driven agents) ──
try:
    from streaming.api.router import router as streaming_router
    app.include_router(streaming_router)
    logger_streaming = True
except Exception as _streaming_err:
    logger_streaming = False
    print(f"[streaming] disabled: {_streaming_err}")
